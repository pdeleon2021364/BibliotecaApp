    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1">
          <h2 className="text-lg font-display font-bold text-madera-900 mb-4">Actividad Reciente</h2>
          <div className="space-y-3">
            {actividadReciente.map((item) => (
              <div key={item.id} className="flex items-start gap-3 pb-3 border-b border-madera-200 last:border-0">
        ...
        <Card className="lg:col-span-2">
          <h2 className="text-lg font-display font-bold text-madera-900 mb-4">Últimos Préstamos</h2>
