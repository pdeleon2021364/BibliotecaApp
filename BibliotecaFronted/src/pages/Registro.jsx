...
import { MdMenuBook, MdPerson, MdEmail, MdLock, MdVisibility, MdVisibilityOff } from "react-icons/md"
...
export default function Registro() {
  ...
  const fieldClass = (field) =>
    `input-ring w-full pl-11 pr-4 py-3 rounded-lg border bg-white text-madera-800 placeholder-madera-400 focus:outline-none focus:ring-2 transition-all duration-200 text-sm hover:border-madera-300 ${
  ...
  return (
    <div className="min-h-screen bg-madera-900 flex">
      <style>{`
        ...
        .anim-fade-in-up-6 { animation: fadeInUp 0.5s ease-out 0.6s both; }
      ...
      {/* Left panel - branding */}
      <div className="hidden lg:flex lg:w-5/12 bg-madera-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-12">
          ...
          <p className="anim-slide-left text-madera-400 text-center text-lg max-w-sm leading-relaxed" style={{ animationDelay: "0.5s" }}>
            Unete a nuestra comunidad y empieza a disfrutar del acceso a nuestra coleccion de libros.
          </p>
      ...
      {/* Right panel - form */}
      <div className="w-full lg:w-7/12 flex items-center justify-center p-6 bg-pergamino-100">
        <div className="w-full max-w-md">
          ...
          <div className="anim-fade-in-up-1">
            <h2 className="text-2xl font-display font-bold text-madera-900">Crear Cuenta</h2>
            <p className="text-madera-500 mt-1 text-sm">Registrate para acceder al sistema</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            ...
            <div className="anim-fade-in-up-1">
              ...
              <div className="relative">
                <MdPerson className={`absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none transition-colors duration-200 ${focusedField === "nombre" ? "text-emerald-500" : "text-amber-500"}`} />
                <input
                  type="text"
                  value={form.nombre}
              ...
              {errors.nombre && <p className="text-xs text-peligro-600 mt-1 anim-fade-in">{errors.nombre}</p>}
            </div>
            ...
            <div className="anim-fade-in-up-4">
              <label className="block text-sm font-medium text-madera-700 mb-1.5">Confirmar contrasena</label>
              <div className="relative">
                <MdLock className={`absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none transition-colors duration-200 ${focusedField === "confirmPassword" ? "text-emerald-500" : "text-amber-500"}`} />
                <input
                  type="password"
              ...
              {errors.confirmPassword && <p className="text-xs text-peligro-600 mt-1 anim-fade-in">{errors.confirmPassword}</p>}
            </div>
            ...
            <div className="anim-fade-in-up-5">
              <button
                type="submit"
                disabled={loading}
                className="btn-shine w-full py-3 rounded-lg bg-madera-800 hover:bg-madera-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium text-sm transition-all duration-200 cursor-pointer active:scale-[0.98] mt-2"
              >
                {loading ? (
            ...
            <div className="anim-fade-in-up-6">
              <p className="text-center text-sm text-madera-500">
                Ya tienes cuenta?{" "}
                <Link to="/login" className="text-madera-800 font-medium hover:text-madera-600 transition-colors duration-200">
                  Iniciar Sesion
                </Link>
              </p>
            </div>
          ...
          <p className="text-center text-xs text-madera-400 mt-8 anim-fade-in-up-6">
